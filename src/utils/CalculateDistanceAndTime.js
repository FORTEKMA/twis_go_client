...
export const sendNotificationToDriver = async (driver, formData, currentUser) => {
  console.log('====================================================');
  ...
  try {
    ...
    console.log(`✅ Notification sent to ${driver.username || notificationId}`);
  } catch (error) {
    console.error(
      `❌ Error sending notification to ${driver.username || notificationId}:`,
